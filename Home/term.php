        ...
        <div class="container" >
            ...
            <div class="collapse navbar-collapse" style=" color: black;">
                <ul class="nav navbar-nav navbar-right" >
                    ...
                    <li class="active"><a href="term.php" style=" color: white;">Term of Use</a></li>
                   
                   
                    <!-- <li><a href="blog.html" style=" color: white;">Blog</a></li>  -->
                    <li><a href="contact-us.html" style=" color: white;">Contact</a></li>
                     <li class="dropdown">
                        <a href="#" class="dropdown-toggle" data-toggle="dropdown" style=" color: white;">Other <i class="icon-angle-down"></i></a>
		    	...
		    	<div class="row">
		    		...
		    		<div class="col-footer col-md-4 col-xs-6">
		    			...
		    			<p class="contact-us-details">
	        				...
	        				<b>Phone:</b> <br/>
	        				<b>Fax:</b> <br/>
	        				<b>Email:</b> <a href="mailto:info@yourcompanydomain.com"></a>
	        			</p>
		    		</div>				
		    		<div class="col-footer col-md-4 col-xs-6">
