									...
									<div class="job-box-filter">
										...
										<div class="col-md-2 col-sm-2" style="background-color: ; padding-top: 0px; float: right;">
												<div class="job-action" style="width: 100%;background-color: green;">
													<a class="edit" href="reference-add.php" title="Add" style="float: right;"><i class="fa fa-plus-circle" aria-hidden="true"></i></a>
        ...
        echo'
			          			...
			          			<div class="brows-job-list">
											...
											<div class="col-md-3 col-sm-3">
												...
												<div class="job-action"style="float:right;">
													<a class="delete" href="ref-update.php?pk_ref='. $row["ref_id"] .'" title="edit" style="float:right;"><i class="fa fa-pencil" aria-hidden="true"></i></a>
