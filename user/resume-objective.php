...
//restriction for fill all the field
		if ( (!empty($_POST['desc']))   )
		{
			...
			echo "<script> location.replace('resume-skills.php'); </script>";
									...
									<div class="job-box-filter">
										<div class="row">
											<div class="col-md-6 col-sm-6">
												<h4><i class="fa fa-picture-o" aria-hidden="true"></i>Objectives (Give atleast 3)<span class="error"><?php echo $error1 ?></span></h4>
											</div>
										</div>
									</div>
