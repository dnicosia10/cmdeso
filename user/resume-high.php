...
//restriction for fill all the field
		if ( (!empty($_POST['name'])) && (!empty($_POST['date'])) && (!empty($_POST['Address']))  )
		{
			...
			$title = ucfirst( strtolower('Highschool'));
			...
			$sql = mysql_query("INSERT INTO appl_info_edu(acct_id,edu_title,edu_name,edu_addr,edu_date_grad)VALUES('$fk','$title','$name','$Address','$date')");
...
// }else{
// 	echo "<script> location.replace('resume-college.php'); </script>";
// }
?>
<!DOCTYPE html>
								...
								<div class="job-box" style="height: 450px;">
									...
									<div class="job-box-filter">
										<div class="row">
											<div class="col-md-6 col-sm-6">
												<h4><i class="fa fa-map-marker" aria-hidden="true"></i> High School</h4>
											</div>
										</div>
									</div>
									...
									<div class="row no-ext-mrg sm-plix">
										...
										<div class="col-sm-6" style="">
											<h5>Last Attended<span class="error"><?php echo $error2 ?></span></h5>
							...
							?>
								<div class="job-box" style="height:450px;">
									...
									<div class="row no-ext-mrg sm-plix">
										...
										<div class="col-sm-6" style="">
											<h5>Date Graduated<span class="error"><?php echo $error2 ?></span></h5>
											<input name="date" type="Date" class="form-control"  >
										</div>
										<div class="col-sm-6" style="width: 100%">
											<h5>Address<span class="error"><?php echo $error3 ?></span></h5>
