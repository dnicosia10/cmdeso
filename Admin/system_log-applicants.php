										...
										<div class="row">
											...
											<div class="col-md-2" >
												...
												<select name="datatable_length"  class="form-control ">
													...
													<?php
															$sql2 = mysql_query("SELECT * FROM appl_info  ");
				...
				<div class="table100">
					<table >
								...
								<thead >
									...
									<th class="column1"><a href="#" title="All Candidate" class="filtsec active" >All (<?php $sqll = mysql_query("SELECT * FROM appl_info  WHERE  appl_fname LIKE '%$search%' OR appl_lname LIKE '%$search%' OR appl_mname LIKE '%$search%'OR appl_birthp LIKE '%$search%' OR appl_birthd LIKE '%$search%' OR appl_age LIKE '%$search%' OR appl_sex LIKE '%$search%' OR appl_zipc LIKE '%$search%' OR appl_email LIKE '%$search%'  ");
								//### fetch data as array
								$num = mysql_num_rows($sqll); echo $num; ?>)</a></th>
									<th class="column3" style="width: 480px;">Full Name</th>
									<th class="column3">Place of Birth</th>
								...
								$sqll = mysql_query("SELECT * FROM appl_info  WHERE  appl_fname LIKE '%$search%' OR appl_lname LIKE '%$search%' OR appl_mname LIKE '%$search%'OR appl_birthp LIKE '%$search%' OR appl_birthd LIKE '%$search%' OR appl_age LIKE '%$search%' OR appl_sex LIKE '%$search%' OR appl_zipc LIKE '%$search%' OR appl_email LIKE '%$search%'  ");
								//### fetch data as array
								$num = mysql_num_rows($sqll);
								while ($row = mysql_fetch_array($sqll))
								{//## echo fetched data to display
								$format_log = date_format(date_create($row['appl_log_date'])," F  d,  Y ");
								$format = date_format(date_create($row['appl_birthd'])," F  d,  Y");
								...
								?>
									...
									<td class="column3" ><?php echo  $row['appl_birthp'] ; ?></td>
									<td class="column3"><?php echo $format ; ?></td>
									<td class="column3"><?php echo $row['appl_email'] ; ?></td>
									<td class="column3 style='padding-right:;'"><?php echo $row['appl_prov'].", ".$row['appl_street'] ; ?></td>
									...
									<thead >
									<tr class="table100-head" >
									<th class="column1"><a href="#" title="All Candidate" class="filtsec active" >All (<?php $sql = mysql_query("SELECT * FROM appl_info    ");
									...
									$sql = mysql_query("SELECT * FROM appl_info    ");
									$num = mysql_num_rows($sql);
									...
									<td class="column3" style="padding-top: 10px;padding-bottom: 10px;"><?php echo $row['appl_fname']." ".$row['appl_mname']." ".$row['appl_lname']." ".$row['appl_sname'] ; ?></td>
									<td class="column3" ><?php echo  $format ; ?></td>
									<td class="column3"><?php echo $row['appl_birthd'] ; ?></td>
									<td class="column3"><?php echo $row['appl_email'] ; ?></td>
									<td class="column3 style='padding-right:;'"><?php echo $row['appl_prov'].", ".$row['appl_street'] ; ?></td>
									<td class="column3 style='padding-right:30px;'">
										<?php echo  $format_log ; ?>
								...
								$end = $_POST['end'];
								$sqll = mysql_query("SELECT * FROM appl_info  WHERE  appl_log_date BETWEEN '$start' AND '$end' ");
								$num = mysql_num_rows($sqll); echo $num; ?>)</a></th>
									<th class="column3" style="width: 480px;">Full Name</th>
									<th class="column3">Place of Birth</th>
									<th class="column3">Date of Birth</th>
								...
								<tr>
									...
									<th class="column1"><a href="#" title="All Candidate" class="filtsec active" >All (<?php $datatable_length = $_POST['datatable_length'];
										...
										$num ="";
										$sql = mysql_query("SELECT * FROM appl_info  LIMIT $datatable_length ");
										$num = mysql_num_rows($sql); echo $num; ?>)</a></th>
									<th class="column3" style="width: 480px;">Full Name</th>
									<th class="column3">Place of Birth</th>
									<th class="column3">Date of Birth</th>
