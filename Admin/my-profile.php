				...
				<div id="page-inner" style="height: auto;">
				   <div class="row" style="height: auto;">
						<div class="col-md-12" style="height: auto;">
							<div class="add-job_container" style="height: auto;">
								<div class="job-box" style="height: 450px;">
									<div class="row no-ext-mrg sm-plix">
										<div class="col-sm-6 col-sm-8 col-sm-offset-2 col-md-offset-3">
										 ...
										 FROM admin_acct  WHERE acct_id = '$num'  ");
												 while ($row = mysql_fetch_array($sql)) {
												 	
												 
												?><span class="designation">Admin</span>
												<h4><?php echo $row['acct_fname'] ." ". $row['acct_lname']; ?></h4>
												<label>Email: 
													<span><?php echo $row['acct_email'];}?></span><a href="account-setting-email.php"><span class="btn btn-default btn-file">
													Change Email 
												</span>
											    </a>
