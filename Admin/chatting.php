					...
					<ul class="nav" id="main-menu">
						...
						<li>
							...
							<ul class="nav nav-second-level">
								<li>
									<a href="active-jobs.php"><i class="active-job fa fa-circle-o-notch" aria-hidden="true"></i>View</a>
								</li>
								<li>
									<a href="job-fair.php"><i class="expire-job fa fa-circle-o-notch" aria-hidden="true"></i>Archived</a>
								</li>
						...
						<li>
							...
							<ul class="nav nav-second-level">
								...
								<li>
									<a href="pending-jobs.php"><i class="expire-job fa fa-circle-o-notch" aria-hidden="true"></i>Archived</a>
								</li>
						...
						<li>
							...
							<ul class="nav nav-second-level">
								<li>
									<a href="active-jobs.php"><i class="active-job fa fa-circle-o-notch" aria-hidden="true"></i>Active</a>
								</li>
								<li>
									<a href="pending-jobs.php"><i class="pending-job fa fa-circle-o-notch" aria-hidden="true"></i>Pending</a>
								</li>
							   <li>
									<a href="expire-jobs.php"><i class="expire-job fa fa-circle-o-notch" aria-hidden="true"></i>Expired</a>
								</li>
							</ul>
						</li>
								...
								<div class="col-sm-3 chat_sidebar">
									 <div class="row">
										...
										<div class="member_list">
										   <ul class="list-unstyled" id="friend-scroll">
											  <li class="left clearfix">
												 <span class="chat-img pull-left">
												 <img src="../../../../lh6.googleusercontent.com/-y-MY2satK-E/AAAAAAAAAAI/AAAAAAAAAJU/ER_hFddBheQ/photo.jpg" alt="User Avatar" class="img-circle">
												 </span>
