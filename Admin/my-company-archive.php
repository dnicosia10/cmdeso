			...
			<div id="page-wrapper" >
				 ...
				 <div class="row bg-title">
					...
					<div class="col-lg-3 col-md-4 col-sm-4 col-xs-12">
						...
						<h4 class="page-title">Company Archive</h4>
					</div>
					<div class="col-lg-9 col-sm-8 col-md-8 col-xs-12">
						<ol class="breadcrumb">
							<li><a href="index.php">Dashboard</a></li>
							<li class="active">Company Archive</li>
						</ol>
					</div>
					<!-- /.col-lg-12 -->
				</div>              
				   ...
				   <div class="row">
						<div class="col-md-12">
							<div class="chat_container">
										...
										<div class="brows-job-list">
											...
											<div class="col-md-6 col-sm-5">
												<div class="brows-job-position">
													<h4><?php echo $row['job_company_name']; ?></h4>
											...
											<div class="col-md-3 col-sm-3">
												<div class="brows-job-location">
													<span class="recent-job-status"><?php echo $row['job_city'].", ". $row['job_street']; ?></span>
												</div>
											</div>
											<div class="col-md-4 col-sm-4	">
												<div class="job-action">
													<form method="POST">
												<input type="hidden" name="val" value="<?php echo $row['job_id']; ?>">
												
												<button name="Archive" style="background-color: transparent;border-style: none;"><a class="delete"  title="Un-Archive"><i class="fa fa-check-circle" aria-hidden="true"></i></a></button>
												</form>		
												</div>
											</div>
										</div>
								...
								$sqll = mysql_query("SELECT * FROM admin_job_fair_info  WHERE job_company_name LIKE '%$search%' OR job_company_slogan LIKE '%$search%' OR job_city LIKE '%$search%' OR job_street LIKE '%$search%' AND job_archive = 'ON' ");
								...
								//$format = date_format(date_create($row['jobfair_date'])," F  d,  Y ");
									...
									<?php }}if(isset($_POST['entries'])){
										...
										$num ="";
										$sql = mysql_query("SELECT * FROM admin_job_fair_info WHERE job_archive = 'ON' LIMIT $datatable_length ");
										while ($row = mysql_fetch_array($sql))
										{//## echo fetched data to display
										//$num += 1;
										//$format = date_format(date_create($row['jobfair_date'])," F  d,  Y ");
									...
									<article>
									 ...
									 <?php
											...
											echo "<script> location.replace('my-company-update.php?id=$id'); </script>";
									 
									 	
											 		echo "<script> location.replace('my-company.php'); </script>";
												}if (isset($_POST['view'])) {
													$id = $_POST['val']; 
													echo "<script> location.replace('my-company-view.php?id=$id'); </script>";
												}if (isset($_POST['Archive'])) {
													$id = $_POST['val']; 
													
													$Archive = "OFF";
											 	
											 		$update = mysql_query("UPDATE admin_job_fair_info SET job_archive='$Archive' WHERE job_id = '$id' ");
											 		echo "<script> location.replace('my-company-archive.php'); </script>";
												}
									 ?>
