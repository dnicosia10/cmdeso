  ...
  $conn = mysql_connect("localhost","root")or die(mysql_error());
	...
	$error1 = $error2 = $error3  = " ";
	 ...
	 if (isset($_POST['submit'])) {
	 	...
	 	$confirm = mysql_query("SELECT * FROM admin_acct WHERE acct_id = '$fk'");
	...
	if ($confpass != $password) {
	 ...
	 if (($email == $oldemail)&&($newemail == $confemail)&&($password == $confpass) ) {
	 	$error1 ="";
	 		...
	 		$update = mysql_query("UPDATE admin_acct SET acct_email = '$newemail'   WHERE acct_id='$fk' ");
				 ...
				 <div class="row bg-title">
					...
					<div class="col-lg-9 col-sm-8 col-md-8 col-xs-12">
						<ol class="breadcrumb">
							Change:
							<li>Email</li>
							<li class="active"><a href="account-setting.php">Password</a></li>
						</ol>
					</div>
					<!-- /.col-lg-12 -->
				</div>              
