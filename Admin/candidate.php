			...
			<div id="page-wrapper" >
				 <div class="row bg-title">
					<div class="col-lg-3 col-md-4 col-sm-4 col-xs-12">
						<h4 class="page-title">My Candidates</h4>
					</div>
					<div class="col-lg-9 col-sm-8 col-md-8 col-xs-12">
						<ol class="breadcrumb">
							<li><a href="index.php">Dashboard</a></li>
							<li class="active">My Candidates</li>
						</ol>
					</div>
					<!-- /.col-lg-12 -->
				</div>              
							...
							<div class="chat_container">
								<div class="job-box" style="height: auto;">
										...
										<div class="row">
											...
											<div class="col-md-7 col-sm-7">
												<div class="filter-search-box text-right">
													<form method="POST">
													<label>Search:<input type="search" style="font-size: 10px;" placeholder="Enter name or gmail....." name="eventc" class="form-control input-sm" placeholder=""><button type="submit" name="okay">Search</button></label>
													</form>
												</div>
											</div>
										</div>
									...
									<div class="row no-ext-mrg">
										<?php
											$one = mysql_query("SELECT * FROM appl_info LIMIT 5	");
										...
										<div class="col-md-4 col-sm-6">
											<div class="candidate-box">
												...
												<div class="candidate-img">
													<a href="">
													<img src="../user/assets/img/<?php echo $row["appl_img"];?>" class="img-circle img-responsive" style="border-radius: 50%;height: 150px;width: 300px;" alt="">
													</a>
												</div>
												<div class="candidate-caption">
													<h4><?php echo $row['appl_fname'] ." ". $row['appl_lname']; ?></h4>
													<span><?php echo $row['appl_email'];?></span>
												</div>
												<div class="candidate-footer" style="height: 50px;">
													<form method="POST">
														<input type="hidden" name="appl_id" value="<?php echo $row['appl_id'] ?>
														">
														<input type="hidden" name="acct_id" value="<?php echo $row['acct_id'] ?>
														">
													<div class="col-md-12 col-sm-12 text-center"><a class="filtsec"><button type="submit" class="btn" name="match"  >View</button></a></div>
													</form>
										...
										<?php
											...
											if (isset($_POST['match'])) {
												$a = $_POST['appl_id'];
												$b = $_POST['acct_id'];
												echo "<script> location.replace('candidate-matchjob.php?a=$a&b=$b'); </script>";
											}
										?>
									...
									<div class="row no-ext-mrg">
										<?php
										$search = $_POST['eventc'];
											$one = mysql_query("SELECT * FROM appl_info WHERE  appl_lname LIKE '%$search%' OR appl_fname LIKE '%$search%' OR appl_email LIKE '%$search%'  ");
											while ($row = mysql_fetch_array($one)) {
									...
									<div class="row no-ext-mrg">
										...
										$datatable_length = $_POST['datatable_length'];
											$one = mysql_query("SELECT * FROM appl_info LIMIT $datatable_length  ");
											while ($row = mysql_fetch_array($one)) {
