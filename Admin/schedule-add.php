...
//restriction for fill all the field
	...
	if (isset($_POST['company-bttn'])) {
		...
		if ( (!empty($_POST['company-name'])) && (!empty($_POST['company-slogan']))&& (!empty($_POST['city'])) && (!empty($_POST['Zip-Code'])) && (!empty($_POST['About-company'])) && (!empty($_POST['Website'])) && (!empty($_POST['call']))&& (!empty($_POST['email'])) && (!empty($_POST['call']))&& (!empty($_POST['facebook'])) && (!empty($_POST['Google']))&& (!empty($_POST['twitter'])) && (!empty($_POST['LinkedIn']))&& (!empty($_POST['instagram'])) && (!empty($_POST['pinterest'])) && (!empty($_POST['street'])) )
		{
			...
			// //uploading the image file
			 if (move_uploaded_file($_FILES['image']['tmp_name'], $target)) {
				 ...
				 echo "<script type='text/javascript'>alert('Successful one')</script>";
				
				 }if (move_uploaded_file($_FILES['image1']['tmp_name'], $target1)) {

				 echo "<script type='text/javascript'>alert('Successful two')</script>";
