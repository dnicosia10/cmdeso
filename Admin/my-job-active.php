							...
							<div class="chat_container" style="height: auto;">
								<div class="job-box" style="height: auto;">
										...
										<div class="row">
											...
											<div class="col-md-7 col-sm-7">
												<div class="filter-search-box text-right">
													<form method="POST">
													<label>Search:<input type="search" style="font-size: 10px;" placeholder=" Search Job names, position, location" name="eventc" class="form-control input-sm" placeholder=""><button type="submit" name="okay">Search</button></label>
													</form>
												</div>
											</div>
										</div>
									...
									$sql = mysql_query("SELECT 
										...
										job_company_name,
										job_img
										 FROM job_onjob_info JOIN admin_job_fair_info WHERE onjob_archive='OFF' AND onjob_status = 'Active' AND job_onjob_info.job_id = admin_job_fair_info.job_id LIMIT 10  ");
										...
										<div class="brows-job-list">
											...
											<div class="col-md-3 col-sm-4">
												<div class="brows-job-position">
													<u><h2><?php echo $row['job_company_name']; ?></h2></u>
											...
											<div class="col-md-12 col-sm-12">
												<div class="brows-job-position">
													...
													<p><?php echo $row['onjob_type']; ?></p>

													<h5 style="padding-top: 20px;">Requirements: </h5><p style="padding-left: 20px;"><?php echo $row['onjob_req']; ?></p>
													<h5 style="padding-top: 20px;">Qualification: </h5><p style="padding-left: 20px;"><?php echo $row['onjob_summary']; ?></p>
													
												</div>
											</div>
											<div class="col-md-6 col-sm-6">
												<div class="brows-job-location">
													<h5 class="recent-job-status" style="padding-top: 20px;"><span class="recent-job-status">When</span></h5>
													<p style="padding-left: 20px;"><?php  echo $row['onjob_datetime']; ?></p>
													<!-- <span class="recent-job-status">WHERE</span> -->
													
												</div>
											</div>
											<div class="col-md-6 col-sm-6">
												<div class="brows-job-location">
													<h5 class="recent-job-status" style="padding-top: 20px;"><span class="recent-job-status">Where</span> </h5>
													<p style="padding-left: 20px;"><?php echo $row['onjob_location']; ?></p>
													<!-- <span class="recent-job-status">WHERE</span> -->
											...
											<div class="col-md-12 col-sm-12	">
												...
												<button name="view" style="background-color: transparent;border-style: none; padding-right: 0px;"><a class="view"   style="" title="view"><i class="fa fa-address-book-o" aria-hidden="true"></i></a></button>
								...
								//$format = date_format(date_create($row['jobfair_date'])," F  d,  Y ");
									...
									<?php }}if(isset($_POST['entries'])){
										...
										$num ="";
										$sql = mysql_query("SELECT * FROM job_onjob_info WHERE onjob_status = 'Active' AND onjob_archive='OFF' LIMIT $datatable_length ");
										while ($row = mysql_fetch_array($sql))
										{//## echo fetched data to display
										//$num += 1;
										//$format = date_format(date_create($row['jobfair_date'])," F  d,  Y ");
									...
									<article>
									 ...
									 <?php
											...
											echo "<script> location.replace('my-job-update.php?id=$id'); </script>";
													...
													$id = $_POST['val']; 
													$idcompany = $_POST['valcompany'];
													$idjobfair = $_POST['valjobfair'];
