										...
										<div class="row">
											...
											<div class="col-md-2" >
												...
												<select name="datatable_length"  class="form-control ">
													...
													<?php
															$sql2 = mysql_query("SELECT * FROM admin_job_fair_info  ");
											...
											<div class="col-md-4">
													...
													<label><input style="width: ;" type="search"  name="eventc" class="form-control input-sm" placeholder="Enter Name or Address"><button type="submit" name="okay">Search</button></label>
				...
				<div class="table100">
					<table >
								...
								<thead >
									...
									<th class="column1"><a href="#" title="All Candidate" class="filtsec active" >All (<?php $sqll = mysql_query("SELECT * FROM admin_job_fair_info  WHERE  job_company_name LIKE '%$search%' OR job_city LIKE '%$search%' OR job_About_company LIKE '%$search%'OR job_street LIKE '%$search%'  ");
								//### fetch data as array
								$num = mysql_num_rows($sqll); echo $num; ?>)</a></th>
									<th class="column3" style="width: 480px;">Name of Company</th>
									<th class="column3">Slogan</th>
									
									<th class="column3">Zip Code</th>
									<th class="column3" style="width:450px; text-align: center;	 ">Address</th>
									<th class="column3" style="padding-right:50px text-align:center; ">Date</th>
								...
								$sqll = mysql_query("SELECT * FROM admin_job_fair_info  WHERE  job_company_name LIKE '%$search%' OR job_city LIKE '%$search%' OR job_About_company LIKE '%$search%'OR job_street LIKE '%$search%'  ");
								//### fetch data as array
								$num = mysql_num_rows($sqll);
								while ($row = mysql_fetch_array($sqll))
								{//## echo fetched data to display
								$format_log = date_format(date_create($row['job_log'])," F  d,  Y ");
								$format = date_format(date_create($row['job_log'])," F  d,  Y");

								?>
									<tr>

									<td class="column2" ></td>
									<td class="column3" style="padding-top: 10px;padding-bottom: 10px;"><?php echo $row['job_company_name']; ?></td>
									<td class="column3" ><?php echo  $row['job_company_slogan'] ; ?></td>
									
									<td class="column3"><?php echo $row['job_Zip_Code'] ; ?></td>
									<td class="column3 style='padding-right:;'"><?php echo $row['job_city'].", ".$row['job_street'] ; ?></td>
									...
									<thead >
									<tr class="table100-head" >
									<th class="column1"><a href="#" title="All Candidate" class="filtsec active" >All (<?php $sql = mysql_query("SELECT * FROM admin_job_fair_info    ");
									...
									$sql = mysql_query("SELECT * FROM admin_job_fair_info    ");
									$num = mysql_num_rows($sql);
								...
								$end = $_POST['end'];
								$sqll = mysql_query("SELECT * FROM admin_job_fair_info  WHERE  job_log BETWEEN '$start' AND '$end' ");
								$num = mysql_num_rows($sqll); echo $num; ?>)</a></th>
									<th class="column3" style="width: 480px;">Name of Company</th>
									<th class="column3">Slogan</th>
								...
								<tr>
									...
									<th class="column1"><a href="#" title="All Candidate" class="filtsec active" >All (<?php $datatable_length = $_POST['datatable_length'];
										...
										$num ="";
										$sql = mysql_query("SELECT * FROM admin_job_fair_info  LIMIT $datatable_length ");
										$num = mysql_num_rows($sql); echo $num; ?>)</a></th>
									<th class="column3" style="width: 480px;">Name of Company</th>
									<th class="column3">Slogan</th>
